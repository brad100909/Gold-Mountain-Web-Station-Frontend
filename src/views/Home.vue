<template>
  ...
  <div class="min-h-screen text-gray-800 relative z-10">
    ...
    <section
      id="hero"
      class="py-28 px-6 text-center relative bg-transparent"
    >
      <!-- 遮罩層 -->
      ...
      <div class="relative z-10">
        ...
        <p class="observe-item opacity-0 text-lg md:text-xl mb-10 max-w-3xl mx-auto leading-relaxed tracking-wide animate-fade-in-up animate-fade-in-up-500">
        ...
        <div class="flex justify-center gap-4">
          <a href="#portfolio" class="px-8 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 transition">
            查看作品
          </a>
          <a href="#contact" class="px-8 py-3 border border-green-700 text-green-700 rounded-lg hover:bg-green-50 transition">
            聯絡我
          </a>
        </div>
      </div>
  ...
  <section class="py-9 px-3 bg-transparent">
    ...
    <section id="contact" class="py-24 px-6 text-center bg-gray-900 text-gray-100">
      <h2 class="text-2xl font-semibold mb-6">有專案需求？</h2>
      <p class="text-gray-400 mb-10">歡迎聯絡我，簡單描述你的需求，我會評估並回覆建議。</p>
      <a href="mailto:your@email.com" class="inline-block px-10 py-4 bg-green-700 text-white rounded-lg hover:bg-green-800 transition">聯絡我</a>
    </section>
  </div>
</template>
